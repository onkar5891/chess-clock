...
class NewGame extends React.Component<Props, State> {
    ...
    render() {
        return (
            <div>
                <Button variant="primary" className="margined" onClick={this.handleOpen}>New</Button>
                <Modal show={this.state.show} animation={false} onHide={this.handleClose} centered>
